...
export function buildBranchNetwork(branches: NetworkBranch[], options?: { compact?: boolean; viewportWidth?: number }): {
  ...
  totalCommits: number; width: number; height: number; incomplete: boolean;
};
